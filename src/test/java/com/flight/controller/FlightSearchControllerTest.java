...
import com.flight.service.impl.FlightSearchServiceImpl;
...
class FlightSearchControllerTest {
	...
	private ResponseEntity<Map<String, List<List<FlightDetail>>>> responseEntity;
	...
	void searchFlightsNullCheck() {
		ResponseEntity<Map<String, List<List<FlightDetail>>>> result = fsc.searchFlight(null, null, null, 0);
	...
	void searchFlights() {
		...
		when(fssi.searchFlights("c", "b",Date.valueOf("2022-05-23"), 1)).thenReturn(expected);
		ResponseEntity<Map<String, List<List<FlightDetail>>>> result = fsc.searchFlight("c", "b",
				Date.valueOf("2022-05-23"), 1);
